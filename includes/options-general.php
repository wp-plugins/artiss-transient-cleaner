...
if ( $array[ 'orphans' ] > 20 ) {
	echo '<div class="error" style="font-weight: bold; text-align: center"><p>' . __( 'A large number of orphaned transients were found. It is recommended that you clear all transients to remove these.' ) . '</p></div>' . "\n";
}
?>
...
$text =  sprintf( __( 'There are currently %s transients in the database.', 'artiss-transient-cleaner' ), $total_transients );
